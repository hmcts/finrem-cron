...
To use the new chart version in CNP Flux config, you are required to create a new tag to trigger the build on Azure pipeline. The chart is published to Azure Container Registry (ACR) under helm/finrem-cron with the same version as the tag.
